...
void GSPlay::Init()
{
	...
	// tube dow
	texture = ResourceManagers::GetInstance()->GetTexture("col_down.tga");
	...
	// tube up
	texture = ResourceManagers::GetInstance()->GetTexture("col_up.tga");
	...
	// bird
	texture = ResourceManagers::GetInstance()->GetTexture("btn_bird.tga");
	shader = ResourceManagers::GetInstance()->GetShader("AnimationShader");

	m_bird = std::make_shared<Animation>(model, shader, texture, 1, 0.1f);
